...
<html lang="en">
	<head>
		...
		<title>A Propos | RentNow - Responsive Car Rental Template</title>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="rn-section-title   ">
							<h2 class="rn-title">Notre Vision</h2>
							<p>Inbecilloque elegans errorem concedo etsi electram.</p>
							<span class="rn-title-bg">Notre Vision</span>
						</div>
				...
				<div class="row">
					...
					<div class="col-md-7 mb-30">
						<h2 class="rn-image-section-title">
							<span>Faites De Belles Choses</span> Avec Passion
						</h2>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						...
						<!-- Section Title-->
						<div class="rn-section-title   ">
							<h2 class="rn-title">Notre Equipe</h2>
							<p>Inbecilloque elegans errorem concedo etsi electram.</p>
							<span class="rn-title-bg">Notre Equipe</span>
						</div>
					...
					<div class="col-md-4">
						...
						<div class="rn-team-member">
							...
							<div class="rn-team-member-info">
								...
								<div class="rn-team-member-designation">Co-Fondateur &amp; PDG</div>
					...
					<div class="col-md-4">
						...
						<div class="rn-team-member">
							...
							<div class="rn-team-member-info">
								...
								<div class="rn-team-member-designation">Co-Fondateur &amp; CTO</div>
								<ul class="rn-team-member-social">
									<li>
										<a href="about.html#">
											<i class="fab fa-facebook-f"></i>
					...
					<div class="col-md-4">
						...
						<div class="rn-team-member">
							...
							<div class="rn-team-member-info">
								...
								<div class="rn-team-member-designation">Développeur Principal</div>
								<ul class="rn-team-member-social">
									<li>
										<a href="about.html#">
											<i class="fab fa-facebook-f"></i>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						...
						<!-- Section Title-->
						<div class="rn-section-title   ">
							<h2 class="rn-title">Nos Partenaires</h2>
							<p>Inbecilloque elegans errorem concedo etsi electram.</p>
							<span class="rn-title-bg">Nos Partenaires</span>
						</div>
									...
									<div class="row rn-quick-links">
										<div class="col-6">
											<ul>
												...
												<li>
													<a href="about.html#">Contactez-Nous</a>
												</li>
												<li>
													<a href="about.html#">Support</a>
												</li>
												<li>
													<a href="about.html#">Voir Réservation</a>
												</li>
												<li>
													<a href="about.html#">Programme d'affiliation</a>
												</li>
												<li>
										...
										<div class="col-6">
											<ul>
												<li>
													<a href="about.html#">Plan Du Site</a>
												</li>
												<li>
													<a href="about.html#">Carrières</a>
												</li>
												<li>
													<a href="about.html#">Presse</a>
												</li>
												<li>
													<a href="about.html#">Obtenu Un Reçu</a>
												</li>
												<li>
													<a href="about.html#">Communauté</a>
												</li>
											</ul>
										</div>
									</div>
