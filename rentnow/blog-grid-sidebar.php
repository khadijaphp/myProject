						...
						<div class="col-8">
							<nav class="rn-navbar-container">
								...
								<ul class="rn-navbar">
									...
									<li>
										<a href="blog-grid-sidebar.html#">Voitures 
										...
										<ul>
											...
											<li>
												<a href="blog-grid-sidebar.html#">Gallerie 
											...
											<li>
												<a href="car-single.html">Voiture Singulier</a>
											</li>
											<li>
									...
									<li>
										<a href="blog-grid-sidebar.html#">Aide &amp; Info 
											<i class="lnr lnr-chevron-down"></i>
										</a>
										<ul>
											<li>
									...
									<li>
										<a href="blog-grid-sidebar.html#">Blog 
											<i class="lnr lnr-chevron-down"></i>
										</a>
										<ul>
											<li>
					...
					<div class="col-lg-8 rn-post-list rn-grid-post-col-2">
											...
											<div class="rn-post-item-title-meta-inner">
												<div class="rn-post-item-meta">
													<span class="rn-post-item-categories">Les 
														<a href="blog-grid-sidebar.html#">Nouveautés</a>
													</span>
													<span class="rn-post-item-author">Par 
														<a href="blog-grid-sidebar.html#">John Doe</a>
													</span>
												</div>
												<h3 class="rn-post-item-title">
													<a href="blog-grid-sidebar.html#">A standard blog post with image</a>
												</h3>
											</div>
										</div>
									</div>
						...
						<nav class="rn-pagination rn-pagination-center">
							<ul>
								...
								<li>
									<a class="rn-active" href="blog-grid-sidebar.html#">1</a>
								</li>
								<li>
									<a href="blog-grid-sidebar.html#">2</a>
								</li>
								<li>
									<a href="blog-grid-sidebar.html#">3</a>
								</li>
								<li>
									<a href="blog-grid-sidebar.html#">4</a>
								</li>
								<li>
									<a href="blog-grid-sidebar.html#">
						...
						<aside class="rn-widget-area" id="secondary">
							...
							<section class="rn-widget">
								...
								<div class="rn-widget-content">
									<ul>
										<li>
											<a href="blog-grid-sidebar.html#">Style de vie</a>
										</li>
										<li>
											<a href="blog-grid-sidebar.html#">Voyage</a>
										</li>
										<li>
											<a href="blog-grid-sidebar.html#">Fashion</a>
										</li>
										<li>
											<a href="blog-grid-sidebar.html#">Musique</a>
										</li>
										<li>
											<a href="blog-grid-sidebar.html#">Branding</a>
										</li>
									</ul>
								</div>
							</section>
							...
							<!-- Widget Item-->
							<section class="rn-widget">
								<h2 class="rn-widget-title">Publications Récentes</h2>
								<div class="rn-widget-content">
												...
												<div class="rn-recent-post-item-info">
													<div class="rn-recent-post-item-meta">
														...
														<span class="rn-recent-post-item-author">Le 
															<a href="blog-grid-sidebar.html#">15 May, 2018</a>
														</span>
													</div>
							...
							<section class="rn-widget">
								...
								<div class="rn-widget-content">
									<div class="tags">
										<a href="blog-grid-sidebar.html#">video</a>
										<a href="blog-grid-sidebar.html#">audio</a>
										<a href="blog-grid-sidebar.html#">images</a>
										<a href="blog-grid-sidebar.html#">javascript</a>
										<a href="blog-grid-sidebar.html#">php</a>
										<a href="blog-grid-sidebar.html#">wordpress</a>
										<a href="blog-grid-sidebar.html#">travel</a>
										<a href="blog-grid-sidebar.html#">music</a>
										<a href="blog-grid-sidebar.html#">python</a>
										<a href="blog-grid-sidebar.html#">ui/ux</a>
										<a href="blog-grid-sidebar.html#">cars</a>
									</div>
								</div>
							</section>
							<!-- End Widget Item-->
		...
		<footer class="rn-footer">
								...
								<div class="rn-widget-content">
									<div class="row rn-quick-links">
										<div class="col-6">
											<ul>
												<li>
													<a href="blog-grid-sidebar.html#">A Propos</a>
												</li>
												<li>
													<a href="blog-grid-sidebar.html#">Contactez-Nous</a>
												</li>
												<li>
													<a href="blog-grid-sidebar.html#">Support</a>
												</li>
												<li>
													<a href="blog-grid-sidebar.html#">Voir Réservation</a>
												</li>
												<li>
													<a href="blog-grid-sidebar.html#">Programme d'affiliation</a>
												</li>
												<li>
													<a href="blog-grid-sidebar.html#">Marketplace</a>
												</li>
											</ul>
										</div>
										<div class="col-6">
											<ul>
												<li>
													<a href="blog-grid-sidebar.html#">Plan Du Site</a>
												</li>
												<li>
													<a href="blog-grid-sidebar.html#">Carrières</a>
												</li>
												<li>
													<a href="blog-grid-sidebar.html#">Presse</a>
												</li>
												<li>
													<a href="blog-grid-sidebar.html#">Obtenir Un Reçu</a>
												</li>
												<li>
													<a href="blog-grid-sidebar.html#">Communauté</a>
												</li>
											</ul>
										</div>
									</div>
			...
			<div class="rn-footer-copyright">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-md-6">
							<p>Copyright &copy; RentNow 2018. Tous les droits sonts réservés.</p>
						</div>
