								...
								<div class="rn-widget-content">
									<div class="row rn-quick-links">
										<div class="col-6">
											<ul>
												<li>
													<a href="cart.html#">A Propos</a>
												</li>
												<li>
													<a href="cart.html#">Contactez-Nous</a>
												</li>
												<li>
													<a href="cart.html#">Support</a>
												</li>
												<li>
													<a href="cart.html#">Voir Réservation</a>
												</li>
												<li>
													<a href="cart.html#">Programmes d'affiliation</a>
												</li>
												<li>
													<a href="cart.html#">Marketplace</a>
												</li>
											</ul>
										</div>
										<div class="col-6">
											<ul>
												<li>
													<a href="cart.html#">Plan Du Site</a>
												</li>
												<li>
													<a href="cart.html#">Carrières</a>
												</li>
												<li>
													<a href="cart.html#">Presse</a>
												</li>
												<li>
													<a href="cart.html#">Obtenu Un Reçu</a>
												</li>
												<li>
													<a href="cart.html#">Communauté</a>
												</li>
											</ul>
										</div>
									</div>
