...
<html lang="en">
	<head>
		...
		<title>Contactez-Nous | RentNow - Responsive Car Rental Template</title>
									...
									<div class="row rn-quick-links">
										<div class="col-6">
											<ul>
												...
												<li>
													<a href="contact.html#">Voir Réservation</a>
												</li>
												<li>
													<a href="contact.html#"> Programme d'affiliation</a>
												</li>
												<li>
													<a href="contact.html#">Marketplace</a>
												</li>
											</ul>
										</div>
										<div class="col-6">
											<ul>
												<li>
													<a href="contact.html#">Plan Du Site</a>
												</li>
												<li>
													<a href="contact.html#">Carrières</a>
												</li>
												<li>
													<a href="contact.html#">Presse</a>
												</li>
												<li>
													<a href="contact.html#">Obtenu Un Reçu</a>
												</li>
												<li>
													<a href="contact.html#">Communauté</a>
												</li>
											</ul>
										</div>
									</div>
