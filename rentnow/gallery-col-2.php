...
<html lang="en">
	<head>
		...
		<title>Gallerie: Colonne 2 | RentNow - Responsive Car Rental Template</title>
						...
						<div class="col-8">
							<nav class="rn-navbar-container">
								...
								<ul class="rn-navbar">
									...
									<li>
										<a href="gallery-col-2.html#">Voitures 
										...
										<ul>
											...
											<li>
												<a href="gallery-col-2.html#">Gallerie 
									...
									<li>
										<a href="gallery-col-2.html#">Aide &amp; Info 
											<i class="lnr lnr-chevron-down"></i>
										</a>
										<ul>
											<li>
									...
									<li>
										<a href="gallery-col-2.html#">Blog 
											<i class="lnr lnr-chevron-down"></i>
										</a>
										<ul>
											<li>
				...
				<div class="row">
					<div class="col-6">
						<a class="rn-lightbox-image" href="assets/images/gallery-1.jpg">
							<img class="img-fluid" src="assets/images/gallery-md-1.jpg" alt="" srcset="assets/images/gallery-md-1.jpg 1x, assets/images/gallery-md-1@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6">
						<a class="rn-lightbox-image" href="assets/images/gallery-2.jpg">
							<img class="img-fluid" src="assets/images/gallery-md-2.jpg" alt="" srcset="assets/images/gallery-md-2.jpg 1x, assets/images/gallery-md-2@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6">
						<a class="rn-lightbox-image" href="assets/images/gallery-3.jpg">
							<img class="img-fluid" src="assets/images/gallery-md-3.jpg" alt="" srcset="assets/images/gallery-md-3.jpg 1x, assets/images/gallery-md-3@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6">
						<a class="rn-lightbox-image" href="assets/images/gallery-4.jpg">
							<img class="img-fluid" src="assets/images/gallery-md-4.jpg" alt="" srcset="assets/images/gallery-md-4.jpg 1x, assets/images/gallery-md-4@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6">
						<a class="rn-lightbox-image" href="assets/images/gallery-5.jpg">
							<img class="img-fluid" src="assets/images/gallery-md-5.jpg" alt="" srcset="assets/images/gallery-md-5.jpg 1x, assets/images/gallery-md-5@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6">
						<a class="rn-lightbox-image" href="assets/images/gallery-6.jpg">
							<img class="img-fluid" src="assets/images/gallery-md-6.jpg" alt="" srcset="assets/images/gallery-md-6.jpg 1x, assets/images/gallery-md-6@2x.jpg 2x">
						</a>
					</div>
				</div>
			</div>
								...
								<div class="rn-widget-content">
									<div class="row rn-quick-links">
										<div class="col-6">
											<ul>
												<li>
													<a href="gallery-col-2.html#">A Propos</a>
												</li>
												<li>
													<a href="gallery-col-2.html#">Contactez-Nous</a>
												</li>
												<li>
													<a href="gallery-col-2.html#">Support</a>
												</li>
												<li>
													<a href="gallery-col-2.html#">Voir Réservation</a>
												</li>
												<li>
													<a href="gallery-col-2.html#">Programme d'affiliation</a>
												</li>
												<li>
													<a href="gallery-col-2.html#">Marketplace</a>
												</li>
											</ul>
										</div>
										<div class="col-6">
											<ul>
												<li>
													<a href="gallery-col-2.html#">Plan Du Site</a>
												</li>
												<li>
													<a href="gallery-col-2.html#">Carrières</a>
												</li>
												<li>
													<a href="gallery-col-2.html#">Presse</a>
												</li>
												<li>
													<a href="gallery-col-2.html#">Obtenu Un Reçu</a>
												</li>
												<li>
													<a href="gallery-col-2.html#">Communauté</a>
												</li>
											</ul>
										</div>
									</div>
