...
<html lang="en">
	<head>
		...
		<title>Gallerie: Colonne 3 | RentNow - Responsive Car Rental Template</title>
						...
						<div class="col-8">
							<nav class="rn-navbar-container">
								...
								<ul class="rn-navbar">
									...
									<li>
										<a href="gallery-col-3.html#">Voitures 
										...
										<ul>
											...
											<li>
												<a href="gallery-col-3.html#">Gallerie 
									...
									<li>
										<a href="gallery-col-3.html#">Aide &amp; Info 
											<i class="lnr lnr-chevron-down"></i>
										</a>
										<ul>
											<li>
									...
									<li>
										<a href="gallery-col-3.html#">Blog 
											<i class="lnr lnr-chevron-down"></i>
										</a>
										<ul>
											<li>
			...
			<div class="container">
				<div class="row">
					<div class="col-6 col-sm-4">
						<a class="rn-lightbox-image" href="assets/images/gallery-1.jpg">
							<img class="img-fluid" src="assets/images/gallery-sm-1.jpg" alt="" srcset="assets/images/gallery-sm-1.jpg 1x, assets/images/gallery-sm-1@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6 col-sm-4">
						<a class="rn-lightbox-image" href="assets/images/gallery-2.jpg">
							<img class="img-fluid" src="assets/images/gallery-sm-2.jpg" alt="" srcset="assets/images/gallery-sm-2.jpg 1x, assets/images/gallery-sm-2@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6 col-sm-4">
						<a class="rn-lightbox-image" href="assets/images/gallery-3.jpg">
							<img class="img-fluid" src="assets/images/gallery-sm-3.jpg" alt="" srcset="assets/images/gallery-sm-3.jpg 1x, assets/images/gallery-sm-3@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6 col-sm-4">
						<a class="rn-lightbox-image" href="assets/images/gallery-4.jpg">
							<img class="img-fluid" src="assets/images/gallery-sm-4.jpg" alt="" srcset="assets/images/gallery-sm-4.jpg 1x, assets/images/gallery-sm-4@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6 col-sm-4">
						<a class="rn-lightbox-image" href="assets/images/gallery-5.jpg">
							<img class="img-fluid" src="assets/images/gallery-sm-5.jpg" alt="" srcset="assets/images/gallery-sm-5.jpg 1x, assets/images/gallery-sm-5@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6 col-sm-4">
						<a class="rn-lightbox-image" href="assets/images/gallery-6.jpg">
							<img class="img-fluid" src="assets/images/gallery-sm-6.jpg" alt="" srcset="assets/images/gallery-sm-6.jpg 1x, assets/images/gallery-sm-6@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6 col-sm-4">
						<a class="rn-lightbox-image" href="assets/images/gallery-7.jpg">
							<img class="img-fluid" src="assets/images/gallery-sm-7.jpg" alt="" srcset="assets/images/gallery-sm-7.jpg 1x, assets/images/gallery-sm-7@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6 col-sm-4">
						<a class="rn-lightbox-image" href="assets/images/gallery-8.jpg">
							<img class="img-fluid" src="assets/images/gallery-sm-8.jpg" alt="" srcset="assets/images/gallery-sm-8.jpg 1x, assets/images/gallery-sm-8@2x.jpg 2x">
						</a>
					</div>
					<div class="col-6 col-sm-4">
						<a class="rn-lightbox-image" href="assets/images/gallery-9.jpg">
							<img class="img-fluid" src="assets/images/gallery-sm-9.jpg" alt="" srcset="assets/images/gallery-sm-9.jpg 1x, assets/images/gallery-sm-9@2x.jpg 2x">
						</a>
					</div>
				</div>
			</div>
								...
								<div class="rn-widget-content">
									<div class="row rn-quick-links">
										<div class="col-6">
											<ul>
												<li>
													<a href="gallery-col-3.html#">A Propos</a>
												</li>
												<li>
													<a href="gallery-col-3.html#">Contactez-Nous</a>
												</li>
												<li>
													<a href="gallery-col-3.html#">Support</a>
												</li>
												<li>
													<a href="gallery-col-3.html#">Voir Réservation</a>
												</li>
												<li>
													<a href="gallery-col-3.html#">Programme d'affiliation</a>
												</li>
												<li>
													<a href="gallery-col-3.html#">Marketplace</a>
												</li>
											</ul>
										</div>
										<div class="col-6">
											<ul>
												<li>
													<a href="gallery-col-3.html#">Plan Du Site</a>
												</li>
												<li>
													<a href="gallery-col-3.html#">Carrières</a>
												</li>
												<li>
													<a href="gallery-col-3.html#">Presse</a>
												</li>
												<li>
													<a href="gallery-col-3.html#">Obtenu Un Reçu</a>
												</li>
												<li>
													<a href="gallery-col-3.html#">Communauté</a>
												</li>
											</ul>
										</div>
									</div>
